...
# Note: Automated tests will be available in future releases
...
4. **Test your changes manually**:
   ```bash
   go build ./cronx.go
   go run ./cronx.go "* * * * *" echo "Test your changes"
   ```
...
3. **Fill out the PR template**:
   ...
   ## Related
   - Closes #CRX-XXX
   - Ref: [CRX-XXX](https://jira.focela.vn/browse/CRX-XXX)
   ```
...
go run ./cronx.go "*/5 * * * *" echo "Every 5 minutes"
go run ./cronx.go "@daily" echo "Daily task"
```

### Future Automated Testing

Automated test suite will be developed in future releases. When available:
...
- **Cron Library**: robfig/cron/v3 for robust cron expression parsing
...
- **Docker**: Container distribution for easy deployment
